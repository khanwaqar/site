                    ...
                    <div class="slideshow-container" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);">
                        ...
                        <div class="hero-title-holder">
                            ...
                            <div class="hero-title">
                                ...
                                <h3>Welcome to 24 Hours Italian Resturant</h3>
                                <h4>The Home Of Taste In West Drayton</h4>
                            </div>
                        </div>
                        <div class="hero-link">
                                ...
                                <div class="col-md-6">
                                    <div class="single-slider-holder">
                                        ...
                                        <div class="single-slider owl-carousel">
                                            <!-- 1 -->
                                            <div class="item">
                                                <img src="images/bg/13.jpg" class="respimg" alt="">
                                            </div>
                                            <!-- 2 -->
                                            <div class="item">
                                                <img src="images/bg/14.jpg" class="respimg" alt="">
                                            </div>
                                            <!-- 3 -->
                                            <div class="item">
...
<!-- Mirrored from lambert.kwst.net/site/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 15:26:54 GMT -->
</html>