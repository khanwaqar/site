...
<!-- Mirrored from lambert.kwst.net/site/reservation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 15:33:07 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
                        ...
                        <div class="nav-holder">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="timigs.php"  class="act-link">Timigs</a></li>
                ...
                <div class="content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="restime" id="restime" class="form-control">
                                                            <option value="12:30pm" selected="true">12:30 pm</option>
                                                        ...
                                                        <!--restaurant-->                                      
                                                        <select class="form-control" name="resrest" id="resrest" onClick="this.select()">
                                                            <option value="24 Hours Italian Resturant">24 Hours Italian Resturant</option>
                                                        </select>
                                                        <!--person-->    
                                                        <select id="numperson" name="numperson" class="form-control" onClick="this.select()" >
                    ...
                    <section class="parallax-section">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="big-number"><a href="#">+44(0)1895447000</a></div>
                                </div>
                            </div>
                        </div>
                    </section>
...
<!-- Mirrored from lambert.kwst.net/site/reservation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 15:33:30 GMT -->
</html>